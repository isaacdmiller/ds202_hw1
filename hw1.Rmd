...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Isaac Miller**. I am majoring in *Financial Counseling and Planning* and minoring in *Data Science* and *Entrepreneurship*. I enjoy being doing outdoor activities like fishing, hicking, and hammocking.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job related to data science and my current major is a career as a financial data scientist. With insights into statistics, predictive analysis, and financial analysis, these individuals serve a company by finding ways to reduce cost and increase company effeciency. A bank or financial company with a team of financial data scienists has the ability to create higher profit margins. link:https://www.nasdaq.com/articles/the-rise-of-the-financial-data-scientist-2019-09-27
    
![](hw1_image.jpg)
    
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I would be most interested in looking into and comparing any corporate financial information over a two to five year period.
    source:https://www08.wellsfargomedia.com/assets/pdf/about/investor-relations/annual-reports/2019-annual-report.pdf
